...
Não faça commit no ficheiro <code>.env</code>! Certifique-se de nunca partilhar ou expor o seu ficheiro <code>.env</code> com ninguém, estará comprometendo sua chave privada. Se usar controlo de versões adicione o ficheiro <code>.env</code> no ficheiro do <a href="https://git-scm.com/docs/gitignore">gitignore</a>.
</InfoBanner>
